...
#------------------------------------------
    ...
    if skip_red == False:
        ...
        for scinum in sim:
            sci_location = sci_list[scinum - scistart]
...
#--------------------------------------------------
        if (fit_lines == True):
            ...
            grapher.plot_vel_lines(vel_fit, vel_fit_linenum, vel_lines, gwave, med_comb, vel_mask, target_dir, objid)
...
#---------------------------------------------------
    ...
    with open(str(target_dir)+"OUT/KARP_OUT_log.txt", "a") as f:
